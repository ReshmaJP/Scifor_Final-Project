...
if st.button("Show Forecast"):
    ...
    Transform_reverssed_J1 = pd.read_csv('Transform_reverssed_J1.csv')
    Transform_reverssed_J2 = pd.read_csv('Transform_reverssed_J2.csv')
    Transform_reverssed_J3 = pd.read_csv('Transform_reverssed_J3.csv')
    Transform_reverssed_J4 = pd.read_csv('Transform_reverssed_J4.csv')
